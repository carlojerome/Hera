...
#Password field
        ...
        rfsh.click()
        print("BOA-CTM-010, passed")

        #BOA-CTM-011 / goto field / negative number
        ...
        print("BOA-CTM-012, passed")
        time.sleep(3)

        #BBOA-CTM-013 / goto field / letters
        human_typing_action_chains(driver,gotopage, "abcd" )
        gotopage.send_keys(Keys.ENTER)
        assert gotopage.get_property("value") == "", (f"Test failed: Text field is not empty! Found: {gotopage.get_property("value")}")
        print("BOA-CTM-013, passed")
        time.sleep(3)

        #BOA-CTM-014 / goto field / valid numbers
        ...
        npage.click()
        time.sleep(3)
        print("BOA-CTM-016, passed")       

        #BOA-CTM-017 / previous page button / <
        ...
        for i in range (3):
            ...
            time.sleep(1)
        time.sleep(3)
        print("BOA-CTM-017, passed")
        #click >> button
        npage = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'nav[aria-label="Pagination"] > button:nth-child(9)')))
        npage.click()
        time.sleep(3)

        #BOA-CTM-018 / previous page button / <<
        ...
        #BOA-CTM-096 / Verify Add Operator using valid "Available Bet Limit ID"
        #click add operator
        add_ope = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'button[class="btn btn-success"]')))
        assert add_ope.is_displayed, "no add operator button displayed"
        add_ope.click()
        ...
        #BBOA-CTM-097 / Verify hyperlinked operator name using (Operator Name)
        ...
        #BOA-CTM-098 / Verify Operator Details using (Operator Name)
        ...
        #BOA-CTM-099 / Verify Operator Details using (Parent Operator Name)
        ...
        #BOA-CTM-100 / Verify Operator Details using (Parent Operator Name Transfer)
        ...
        #BOA-CTM-101 / Verify Parent Operator Details using (Wallet Type)
        ...
        #BOA-CTM-102 / Verify Parent Operator Details using (Currency)
        #check first the wallet type
        ...
        #BOA-CTM-103 / "Verify More Details > Basic Info using (Operator ID - Read Only)"
        ...
        #BOA-CTM-104 / "Verify More Details > Basic Info using (Host URL)"
        #back to operator list again
        back_to_operator_list = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'a[href="/content_management/operator"]')))
        assert back_to_operator_list.is_displayed(), "no back to operator list button"
        print("✅ back_to_operator_list button is visible")
        ...
        #BOA-CTM-105 / "Verify More Details > Basic Info using (Public Key)" / public key is able to read upon clickng the eye
        #back to operator list again
        back_to_operator_list = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'a[href="/content_management/operator"]')))
        assert back_to_operator_list.is_displayed(), "no back to operator list button"
        print("✅ back_to_operator_list button is visible")
        ...
        #BOA-CTM-106 / "Verify More Details > Basic Info using (Public Key)" / public key is not able to read upon clickng the eye
        ...
        #BOA-CTM-107 / "Verify More Details > Basic Info using (Public Key)" / refresh button
        #click again the eye
        eye = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'form[class="w-full"] > div > div:nth-child(7) > div > button:nth-child(1)')))
        assert eye.is_displayed(), "no public key field"
        eye.click()
        ...
        #BOA-CTM-108 / "Verify More Details > Basic Info using (Private Key)" / private key is able to read upon clickng the eye
        ...
        #BOA-CTM-109 / "Verify More Details > Basic Info using (Private Key)" / private key is not able to read upon clickng the eye
        ...
        #BOA-CTM-110 / "Verify More Details > Basic Info using (Private Key)" / refresh button
        #click again the eye
        eye_pk = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'form[class="w-full"] > div > div:nth-child(2) > div > button:nth-child(1)')))
        assert eye_pk.is_displayed(), "no private key field"
        eye_pk.click()
        ...
        #BOA-CTM-111 / Verify More Details > Basic Info using (Whitelist IP)
        ...
        #BOA-CTM-112 / Verify More Details > Basic Info using (Pool ID)
        ...
        #BOA-CTM-113 / Verify More Details > Basic Info using (Status)
        ...
        #BOA-CTM-114 / Verify More Details > Basic Info using (API Version)
        ...
        #BOA-CTM-115 / Verify More Details > Basic Info using (Update Button)
        ...
        # #User should be able to manage Operator Details
        # #BOA-CTM-122 / Verify Operator Details using (Operator Name)
        # #click the hyperlinked operator name
        # hyperlinked_opename = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'tbody > tr:nth-child(2) > td:nth-child(1) > a')))
        # assert hyperlinked_opename.is_displayed(), "operator name is not displayed"
        # print("✅ hyperlinked name is visible.")
        ...
        #BOA-CTM-122 / Verify content in Column (Operator Name)
        # Wait for table to load
        table_rows = wait.until(EC.presence_of_all_elements_located((By.CSS_SELECTOR, 'tbody > tr')))
        assert len(table_rows) > 0, "❌ No rows found in the table"
        ...
        #BOA-CTM-123 / Verify content in Column (Operator ID)
        # Wait for table to load
        table_rows = wait.until(EC.presence_of_all_elements_located((By.CSS_SELECTOR, 'tbody > tr')))
        assert len(table_rows) > 0, "❌ No rows found in the table"
        ...
        #BOA-CTM-124 / Verify content in Column (Currency)
        ...
        #BOA-CTM-125 / Verify content in Column (Wallet Type)
        ...
        #BOA-CTM-126 / Verify content in Column (Status)
        ...
        #BOA-CTM-127 / Verify content in Column (Date Created)
        ...
        print("✅ BOA-CTM-127: All 'Created Date' values are valid.")
        time.sleep(2)

        #BOA-CTM-128 / Verify content in Column (Action)
        ...
        #BOA-CTM-130 / refresh button
        rfsh = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'button[class="btn-refresh"]')))
        assert rfsh.is_displayed(), "no refresh button"
        rfsh.click()
        print("BOA-CTM-130, passed")

        #BOA-CTM-131 / goto field / negative number
        gotopage = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'div[class="flex gap-x-2 items-center h-[32px] mx-2 text-gray-800"] > input')))
        assert gotopage.is_displayed(), "No goto page field found"
        gotopage.click()
        time.sleep(3)
        ...
        #BOA-CTM-133 / goto field / letters
        human_typing_action_chains(driver,gotopage, "abcd" )
        gotopage.send_keys(Keys.ENTER)
        assert gotopage.get_property("value") == "", (f"Test failed: Text field is not empty! Found: {gotopage.get_property("value")}")
        ...
        #BOA-CTM-134 / goto field / valid numbers
        human_typing_action_chains(driver,gotopage, "5")
        gotopage.send_keys(Keys.ENTER)
        page1 = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'nav[aria-label="Pagination"] > button:nth-child(7)')))
        assert page1.text == "5", (f"Test failed: Page Number is Incorrect! Found: {page1.text}")
        ...
        #BOA-CTM-137 / previous page button / <
        prev = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'nav[aria-label="Pagination"] > button:nth-child(2)')))
        assert prev, "no previous page button"
        for i in range (3):
            prev.click()
        ...
        #BOA-CTM-138 / previous page button / <<
        twoarrow = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'nav[aria-label="Pagination"] > button:nth-child(1)')))
        assert twoarrow.is_displayed, "no go to first page button"
        twoarrow.click()
        time.sleep(3)
        ...
        #BOA-CTM-141 / "Verify the Export button with overall data showing in table (Export Overall Data)"
        export = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'button[class="btn-export"]')))
        export.click()
        time.sleep(1)
        #check if there's success prompt
        ...
        print("✅ BOA-CTM-141, passed")
        driver.refresh()
        time.sleep(3)

        #BOA-CTM-142 / "Verify the Export button with specific data showing in table (Export Specific Data)"
        bell = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, ' div[class="user-controls"] > div:nth-child(2)')))
        time.sleep(1)
        bell.click()
        time.sleep(2)
        ...
        #BOA-CTM-143 / "Verify the Export button with no data showing in table (Empty Export)"
        #select operator name
        oper = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'input[id="operator_id"]')))
        oper.click()
        time.sleep(2)
