...
#Password field
        ...
        #BOA-CTM-093 / Verify Operator Details using (Operator Name)
        ...
        #BOA-CTM-094 / Verify Operator Details using (Operator Name)
        ...
        #BOA-CTM-095 / Verify Operator Details using (Parent Operator Name)
        ...
        #BOA-CTM-096 / Verify Operator Details using (Parent Operator Name Transfer)
        ...
        #BOA-CTM-097 / Verify Parent Operator Details using (Wallet Type)
        ...
        #BOA-CTM-098 / Verify Parent Operator Details using (Currency)
        #check first the wallet type
        ...
        #BOA-CTM-099 / "Verify More Details > Basic Info using (Operator ID - Read Only)"
        ...
        #BOA-CTM-100 / "Verify More Details > Basic Info using (Host URL)"
        #back to operator list again
        back_to_operator_list = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'a[href="/content_management/operator"]')))
        assert back_to_operator_list.is_displayed(), "no back to operator list button"
        print("✅ back_to_operator_list button is visible")
        ...
        #BOA-CTM-101 / "Verify More Details > Basic Info using (Public Key)" / public key is able to read upon clickng the eye
        #back to operator list again
        back_to_operator_list = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'a[href="/content_management/operator"]')))
        assert back_to_operator_list.is_displayed(), "no back to operator list button"
        print("✅ back_to_operator_list button is visible")
        ...
        #BOA-CTM-102 / "Verify More Details > Basic Info using (Public Key)" / public key is not able to read upon clickng the eye
        ...
        #BOA-CTM-103 / "Verify More Details > Basic Info using (Public Key)" / refresh button
        #click again the eye
        eye = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'form[class="w-full"] > div > div:nth-child(7) > div > button:nth-child(1)')))
        assert eye.is_displayed(), "no public key field"
        eye.click()
        ...
        #BOA-CTM-104 / "Verify More Details > Basic Info using (Private Key)" / private key is able to read upon clickng the eye
        ...
        #BOA-CTM-105 / "Verify More Details > Basic Info using (Private Key)" / private key is not able to read upon clickng the eye
        ...
        #BOA-CTM-106 / "Verify More Details > Basic Info using (Private Key)" / refresh button
        #click again the eye
        eye_pk = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, 'form[class="w-full"] > div > div:nth-child(2) > div > button:nth-child(1)')))
        assert eye_pk.is_displayed(), "no private key field"
        eye_pk.click()
        ...
        #BOA-CTM-107 / Verify More Details > Basic Info using (Whitelist IP)
        ...
        #BOA-CTM-108 / Verify More Details > Basic Info using (Pool ID)
        ...
        #BOA-CTM-109 / Verify More Details > Basic Info using (Status)
        ...
        #BOA-CTM-110 / Verify More Details > Basic Info using (API Version)
        ...
        #BOA-CTM-111 / Verify More Details > Basic Info using (Update Button)
        ...
        time.sleep(1)
        human_typing_action_chains(driver, change_url, generate_random_text())
        time.sleep(1)
        ...
        expected_currency = ["CNY", "THB", "PHP", "KRW", "USD", "IDR"]
        # Wait for table to load
        table_rows = wait.until(EC.presence_of_all_elements_located((By.CSS_SELECTOR, 'tbody > tr')))
        assert len(table_rows) > 0, "❌ No rows found in the table"
